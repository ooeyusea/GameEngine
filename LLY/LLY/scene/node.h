...
namespace lly {
    ...
    public:
		...
		void set_position_z(float z) { _position.z = z; }
        const glm::vec3& get_position() { return _position; }
		inline glm::vec3 get_world_position()
		{
			glm::vec4 ret = _transform * glm::vec4(_position, 1.f);
		...
		void set_scale_z(float z) { _scale.z = z; }
